...
static void warn5mnLeft()
{
	...
	system("/opt/muos/extra/mufbset -o /opt/muos/share/overlay/standard/5mnLeft.png -p 224,144 -t 5");
}
...
static int process(void) 
{
	...
	LOG_DEBUG("muxparentlock", "Parent lock process created, maxTimeForToday %u/addtime %u", maxTimeForToday, additionalTime)
	...
	while (!exit_required)
	{
		...
		if (elapsed > fiveMinBefore) warn5mnLeft();
